...
const features = [
  ...
  },
  {
    ...
    description:
      "Experience Lightning-fast answers to your queries, ensuring you get information you need instantly",
    icon: ZapIcon,
  },
  {
  ...
  },
  {
    ...
    description:
      "Access and chat with your documents seamlessly on any device. weather it's your desktop, tablet, or smartphone",
    ...
    <div className="p-2">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl md:px-6 lg:px-8">
          ...
          <Button asChild className="mt-10 py-3.5">
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:max-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y16">
